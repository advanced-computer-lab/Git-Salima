...
const Flight = () => {
  ...
  const searchFlight = async (e) => {
    ...
    localStorage.setItem(
      "UFSDAirport",
      localStorage.getItem("OutboundDepAirportEdit")
    );
    localStorage.setItem(
      "UFSAAirport",
      localStorage.getItem("OutboundArrAirportEdit")
    );
    localStorage.setItem("UFSDDate", tweakDate(DepartureDate));
    localStorage.setItem(
      "UFSRDate",
      tweakDate(localStorage.getItem("ReturnDepDateEdit"))
    );
    ...
    history.push("/user-dep-flights-edit");
  };
                ...
                <div className="row">
                  <div className="col">
                    <TextField
                      ...
                      defaultValue={localStorage.getItem(
                        "OutboundDepAirportEdit"
                      )}
                      variant="filled"
                      value={localStorage.getItem("OutboundDepAirportEdit")}
                    />
                  </div>
                  ...
                  <div className="col-md-10">
                    <TextField
                      ...
                      defaultValue={localStorage.getItem(
                        "OutboundArrAirportEdit"
                      )}
                      variant="filled"
                      value={localStorage.getItem("OutboundArrAirportEdit")}
                    />
                  </div>
                </div>
                <br />
