...
export default function FlightCard(props) {
    ...
    const editRetFlightHandler = () => {
        props.onClickEditRetFlight(props);
    };

    const changeRetSeatsHandler = () => {
        props.onClickChangeRetSeats(props);
    };
                    ...
                    <CardContent style={{ backgroundColor: "#EFEAE4" }}>
                        ...
                        >
                            <Typography
                                ...
                                alignItems="center"
                            >
                                Return Flight Number: {props.FlightNo}
                            </Typography>
                        </Stack>
                        <Stack
                            direction="row"
                        ...
                        <CardActions>
                            <ColorButton variant="contained" onClick={editRetFlightHandler}>
                                Edit Flight
                            </ColorButton>
                            <ColorButton variant="contained" onClick={changeRetSeatsHandler}>
                                Change Seats
                            </ColorButton>
                        </CardActions>
                    </CardContent>
